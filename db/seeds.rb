...
puts "creating 25 fake pigs"
  ...
  address: "Am Lustgarten 1, Berlin",
  weight: rand(25..500),
  age: rand(2..100),
  price: rand(1..100),
...
address: "Am Kupfergraben 1, Berlin",
weight: rand(25..500),
age: rand(2..100),
price: rand(1..100),
...
address: "Pfarrgasse 2, Böblingen",
weight: rand(25..500),
age: rand(2..100),
price: rand(1..100),
...
file = URI.open("https://images.unsplash.com/photo-1598493253616-1f2bc5d63991?fit=crop&w=800&q=80")
pig.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
pig.save!
...
file = URI.open("https://images.unsplash.com/photo-1587007451503-4a5aa58abfc5")
pig.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
pig.save!
...
address: "Universitätsstraße 100, Köln",
weight: rand(25..500),
age: rand(2..100),
price: rand(1..100),
...
file = URI.open("https://images.unsplash.com/photo-1533586473300-f66da55c9cf7?fit=crop&w=800&q=80")
pig.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
pig.save!
...
file = URI.open("https://images.unsplash.com/photo-1546981969-f0c74fe14902?fit=crop&w=800&q=80")
pig.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
pig.save!
...
file = URI.open("https://images.unsplash.com/photo-1543360308-232162ffd6e2?fit=crop&w=800&q=80")
pig.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
pig.save!
...
pig = Pig.new(
  ...
  file = URI.open("https://images.unsplash.com/photo-1516467508483-a7212febe31a?fit=crop&w=800&q=80")
  pig.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
  pig.save!
...
address: "Klosterwall 15, Hamburg",
weight: rand(25..500),
age: rand(2..100),
price: rand(1..100),
...
file = URI.open("https://ais.badische-zeitung.de/piece/06/4e/cb/4d/105827149-h-720.jpg")
pig.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
pig.save!
...
address: "Kaiser-Wilhelm-Str. 2, Saarlouis",
weight: rand(25..500),
age: rand(2..100),
price: rand(1..100),
...
file = URI.open("https://images.unsplash.com/photo-1550825570-1959166c6e66?fit=crop&w=800&q=80")
pig.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
pig.save!
...
address: "Museumstraße 23, Hamburg",
weight: rand(25..500),
age: rand(2..100),
price: rand(1..100),
...
address: "Lerchenfeldstraße 3, München",
weight: rand(25..500),
age: rand(2..100),
price: rand(1..100),
...
file = URI.open("https://images.unsplash.com/photo-1591175660774-2a59438ceaf5?fit=crop&w=800&q=80")
pig.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
pig.save!
...
user: User.last,
profession: "Rockstar",
address: "Kurfürstendamm 30, Berlin",
weight: rand(25..500),
age: rand(2..100),
price: rand(1..100),
